...
| Cold-open anatomical instrument (hero) | Original inline SVG in `index.html`, drawn from general human-anatomy knowledge; no external, stock or copied medical figure is fetched, traced or embedded | Project-authored | Anterior-torso schematic (lungs, heart and great vessels, liver, stomach, kidneys, intestines). Cool strokes are anatomical context; coral reticles mark only the tissues cited studies sampled — lung (Jenner 2022, `P01-SOURCE-004`/`P01-CLAIM-001`) and arterial plaque (Marfella 2024, `P01-SOURCE-005`/`P01-CLAIM-002`). Labelled “illustrative · not to scale”; encodes no dose, prevalence or risk. |
